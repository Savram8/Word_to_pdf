#The purpose of this script is to take a folder of word documents and create that same folder but as pdf's
#Original Code is from Fabian Mayer, made minor changes to it: http://code.activestate.com/recipes/578858-convert-doc-and-docx-files-to-pdf/
